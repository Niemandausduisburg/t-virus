...
read -n 1 -p $"Are you ready to flash T-VIRUS 2.0? 
Yes [y]
No [n]" answer1
if [ "$answer1" == "y" ]
then
clear
read -n 1 -p $"Have you read the warnings and are you sure you want to proceed? 
Yes [y]
No [n]" answer2
if [ "$answer2" == "y" ]
then
clear
read -n 1 -p $"Boot your device into fastboot, bootloader or download mode and connect it to your PC. Enter [f] when your device is in fastboot-mode and connected to your PC to proceed." answer3
if [ "$answer3" == "f" ]
then
clear
echo "ATTENTION!!!"
